...
\begin{description}
	...
	\item [$\alpha_5$] L'angolo formato è compreso tra \ang{180} e \ang{270}, in radianti è compreso tra $\pi$ e $\dfrac{3}{2}\pi$. L'ordinata del punto $P_5$ è negativa quindi il seno $\sin\alpha_2$ è negativo.
	\item [$\alpha_6$] L'angolo formato è la somma di tre angoli retti. Il punto ha ordinata meno uno quindi $\sin\alpha_6=-1$.
	\item [$\alpha_7$] L'angolo è compreso tra \ang{270} e \ang{360}, in radianti tra $\dfrac{3}{2}\pi$ e $2\pi$. L'ordinata del punto $P_7$ è negativa quindi $\sin\alpha_7$ è negativo.
...
\begin{description}
	...
	\item [$\alpha_3$] L'angolo è ottuso. Il prolungamento del raggio incontra le retta in $ C_3$ con valori dell'ascissa negativi. Quindi $\tan\alpha_3$ è negativo.
...
\begin{description}
	...
	\item [$\alpha_6$] L'angolo è di duecentosettanta gradi. In questo caso il prolungamento del raggio incontra la parallela all'asse $x$. in $ C_6$. In questo $\tan\alpha_6$ vale zero. 
...
\end{align*}
\subsection{Equazione elementare seno }
...
x&=\ang{100}+k\ang{360}
	\end{align*}
\subsection{Equazione elementare coseno}
...
x&=\ang{80}+k\ang{180}
	\end{align*}
\subsection{Equazione elementare tangente}
