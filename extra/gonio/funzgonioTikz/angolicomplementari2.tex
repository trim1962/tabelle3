...
\begin{document}
	...
	\draw(Q)--(QX)node[midway,left] {$\sin(\ang{90}+\alpha)$};
	\draw [->] (0:\sraggio/5) arc (0:\sangolo:\sraggio/5);
	\draw (\sangolo/2:\sraggio/5) node[right] {$\ang{90}+\alpha$};
