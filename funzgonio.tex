...
\begin{figure}
	...
	\begin{subfigure}[b]{.5\linewidth}
	\centering
		\includestandalone[width=0.6\textwidth]{funzgonioTikz/cosenografico}
...
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/circonferenzagoniometrica}
...
\begin{figure}
		\centering
\includestandalone[width=0.6\textwidth]{funzgonioTikz/andamentocoseno1}
		\captionof{figure}{Andamento coseno $\ang{0}<\alpha<\ang{180}$}\label{fig:AndamentoCoseno1}
	\end{figure}%
	\begin{figure}
		\centering
\includestandalone[width=0.6\textwidth]{funzgonioTikz/andamentocoseno2}
...
%		\centering\includegraphics[scale=0.35]{senoalpha-crop}
	...
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=0.6\textwidth]{funzgonioTikz/senografico}
...
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/andamentoseno1}
...
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/andamentoseno2}
...
\begin{figure}
	...
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering\includestandalone[width=0.6\textwidth]{funzgonioTikz/tangentegrafico}
...
\begin{figure}
	\centering
\includestandalone[width=0.6\textwidth]{funzgonioTikz/tangenteandamento1}
	\captionof{figure}{Andamento tangente $\ang{0}<\alpha<\ang{180}$}\label{fig:AndamentoTangente1}
\end{figure}%
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/tangenteandamento2}
...
\begin{figure}
	...
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering\includestandalone[width=0.6\textwidth]{funzgonioTikz/cotangentegrafico}
...
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/cotangenteandamento1}
...
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/cotangenteandamento2}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=4.5cm]{funzgonioTikz/acrsengrafico2}
		\caption{Grafico di $\arcsin x$}\label{fig:ArcSenGrafico}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=4.5cm]{funzgonioTikz/acrcosengrafico2}
		\caption{Grafico di $\arccos x$}\label{fig:ArcCosenGrafico}
	\end{subfigure}
		\begin{subfigure}[b]{\linewidth}
			\centering
	\includestandalone{funzgonioTikz/arcotangente2}
		\caption{Grafico di $\arctan x$}\label{fig:ArcTangenteGrafico}
		\end{subfigure}
		\begin{subfigure}[b]{\linewidth}
		\centering
		\includestandalone{funzgonioTikz/arcocotangente2}
...
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/RelFondGoniometria}
...
\begin{figure}
	...
	\centering
	\includestandalone[width=\textwidth]{funzgonioTikz/angoliassociati1}\caption{Angoli supplementari $\alpha$ $\ang{180}-\alpha$}\label{fig:AngoliAssociatisupplementari}		
 \end{subfigure}
 \begin{subfigure}[b]{.48\linewidth}
 	\centering
 	\includestandalone[width=\textwidth]{funzgonioTikz/angoliassociati2}
 	\caption{Angoli che differiscono di $\ang{180}$ $\alpha$ e $\ang{180}+\alpha$}
 	\label{fig:AngoliAssociatidiff180}	
 \end{subfigure}
 	\begin{subfigure}[b]{.49\linewidth}
 		\centering
 		\includestandalone[width=\textwidth]{funzgonioTikz/angoliassociati3}
 		\caption{Angoli esplementari $\alpha$ e $\ang{360}-\alpha$}\label{fig:Angolidif360}
 	\end{subfigure}
 	\begin{subfigure}[b]{.49\linewidth}
 		\centering
 		\includestandalone[width=\textwidth]{funzgonioTikz/angoliopposti}
...
\begin{figure}
	\begin{subfigure}[b]{.49\linewidth}
 	\centering
 	\includestandalone[width=\textwidth]{funzgonioTikz/angolicomplementari1}
 	\caption{Angoli complementari $\alpha$ e $\ang{90}-\alpha$}\label{fig:angolicomplementari1}
 \end{subfigure}
 	\begin{subfigure}[b]{.49\linewidth}
 		\centering
 		\includestandalone[width=\textwidth]{funzgonioTikz/angolicomplementari2}
 		\caption{Angoli che differiscono di $\ang{90}$, $\alpha$ e $\ang{90}+\alpha$}\label{fig:angolicomplementari2}
 	\end{subfigure}
 \begin{subfigure}[b]{.49\linewidth}
 		\centering
 		\includestandalone[width=\textwidth]{funzgonioTikz/angolicomplementari3}
 		\caption{Angoli la cui somma è $\ang{270}$, $\alpha$ e $\ang{270}-\alpha$}\label{tab:angolicomplementari3}	
 	\end{subfigure}
	\begin{subfigure}[b]{.49\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzgonioTikz/angolicomplementari4}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareSeno4}
		\captionof{figure}{$\sin x=m$\ $-1<m<0$}\label{fig:EquaElementareSeno4}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareCoseno4}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
			\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareSeno1}
			\captionof{figure}{$\sin x=m$\ $0<m<1$}\label{fig:EquaElementareSeno1}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareCoseno1}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareSeno2}
	\captionof{figure}{$\sin x=1$}\label{fig:EquaElementareSeno2}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareSeno3}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareCoseno3}
	\captionof{figure}{$\cos x=m$ $m=-1$}\label{fig:EquaElementareCoseno3}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementareCoseno2}
...
\begin{figure}
	\centering
	\includestandalone[width=0.6\textwidth]{funzgonioTikz/EquaElementaretangente1}
