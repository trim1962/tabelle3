...
Un angolo è retto\index{Angolo!retto} quando è la metà di un angoli piatto. 
\end{definizionet}
...
&\sin\alpha={}\pm\dfrac{1}{\sqrt{1+{\cot}^{2}\alpha}} &\alpha{}&\alpha&{}\neq& k\pi\\
&\cos^{2}\alpha={}\dfrac{\cot^{2}\alpha}{1+\cot^{2}\alpha}&\alpha{}&\alpha&{}\neq& k\pi\\
&\cos\alpha={}\pm\dfrac{\cot\alpha}{\sqrt{1+\cot^{2}\alpha}}&\alpha{}&\alpha&{}\neq&k\pi\\
\end{align*}
\end{teoremat}
\begin{proof}
