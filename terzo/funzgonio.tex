...
\end{figure}
Sono angoli la cui somma\index{Angoli!Somma!$\ang{180}$} come gli angoli $\ang{180}$, $\alpha$, $\ang{180}-\alpha$ la figura corrispondente è la\nobs\vref{fig:AngoliAssociatisupplementari}
...
\end{figure}
Il seno di un angolo è una funzione limitata con valori  tra meno uno ed uno compresi $(1\leq\sin x\leq 1)$ quindi l'equazione è impossibile per valori di $m$ esterni a tale intervallo. Abbiamo vari casi:
\begin{description}
