...
I lati di un triangolo sono classificati, rispetto a un angolo, come opposti o adiacenti. Guardando la figura\nobs\vref{fig:triangolooppostoadiacente}, diciamo che rispetto all'angolo $\gamma$, il segmento $AC$ è adiacente perché appartiene a un  lato dell'angolo. Il segmento  $AB$ è opposto a$\gamma$\index{Angolo!opposto}\index{Angolo!adiacente} perché  non appartiene ai lati  dell'angolo.\par
