...
\end{align*}
analogo risultato non si ottiene procedendo nel seguente modo
\begin{align*}
a=&\sqrt{8^2+4^2}\approx\num[round-precision=2,round-mode=places]{8.94427191}\\
\beta=&\arctan\dfrac{b}{c}\\
...
\end{align*}
Questa divergenza nei risultati segue dal aver arrotondato nella prima parte, alla seconda decimale per $a$ e mostra come convenga utilizzare durante i calcoli una maggiore precisione.
