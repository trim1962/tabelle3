...
\begin{teoremat}{Di Carnot}{}
	In un triangolo qualunque\index{Teorema!Carnot} valgono le seguenti uguaglianze:
	\begin{align*}
...
\begin{figure}
	\centering
	\includestandalone[width=0.7\linewidth]{terzo/trigonometria/Parasommavettori}
