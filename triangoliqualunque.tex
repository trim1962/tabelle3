...
In un triangolo qualunque l'angolo maggiore non è necessariamente retto. La nomenclatura dei lati, spigoli ed angoli è analoga a quella di un triangolo rettangolo. Ricordiamo che  in un triangolo un lato è minore della somma degli altri due e che l'unione degli angoli interni è un angolo piatto. Abbiamo quindi:
 \begin{align*}
a<&b+c\\
b<&a+c\\
c<&b+a\\
...
\end{teoremat}
Quindi in un triangolo, il rapporto fra il lato e il seno dell'angolo opposto è costante ed questo è uguale al diametro della circonferenza circoscritta. Si può dire che il seno e l'angolo sono direttamente proporzionali. La figura\nobs\vref{fig:TeoremDeiSeni} mostra le relazioni.
