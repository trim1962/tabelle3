...
\begin{definizionet}{Unità immaginaria}{}
	Chiamiamo unità immaginaria\index{Unità!immaginaria} $\uimm$ il simbolo definito da \[\uimm^2=-1\]  
\end{definizionet}
...
Dato un numero complesso $z=a+b\uimm$,  opposto\index{Numero!complesso!oppoto} 
...
\begin{definizionet}{Vettore}{}
	Un vettore\index{Vettore} è un segmento orientato. Un segmento che ha 
...
Argand-Gauss\index{Argand-Gauss!piano}.\par  
...
\begin{figure}
	\centering
	\includestandalone[width=\textwidth]{complessi/complessi00}
	\caption{Piano complesso}
	\label{fig:nuncomplPianoComplesso}
\end{figure}
\begin{figure} %[htbp]
	\centering
\includestandalone[width=\textwidth]{complessi/complessi0}
...
La differenza tra due numeri complessi è più difficile da rappresentare  dal punto di vista grafico. Si procede come nella figura\nobs\vref{fig:DifferenzaPianoComplesso}. \[ z=z_1-z_2=z_1+(-z_2)\]  Quindi la differenza fra due numeri si trasforma nella somma con l'opposto.
\begin{figure}
	\centering
	\includestandalone[width=\textwidth]{complessi/complessi1}
...
\end{esempiot}
	...
	Lo zero\index{Numero!complesso!zero} nei numeri complessi ha la seguente forma
	\[0=0+0\uimm\]
...
\begin{figure}
	\centering
	\includestandalone[width=\textwidth]{complessi/complessi2}
...
\end{esempiot}	
	...
	\begin{table}
		...
		\begin{tabular}{lC}
			...
			d)=\frac{a+\uimm b}{c+\uimm d}=\frac{(a+\uimm b)\cdot(c-\uimm 
			d)}{c^2+d^2}\\
			\bottomrule
		\end{tabular}
...
%\begin{figure} %[htbp]
%	\centering
%\includestandalone[width=.6\textwidth]{complessi/polar-plot}
